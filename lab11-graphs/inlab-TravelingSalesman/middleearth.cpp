// REESE ALLEN | rga2uz | 11-17-20 | middleearth.cpp
...
/**
 * @constructor MiddleEarth Creates a new world with given size and number of cities
 * 
 * @param xsize Width of the world
 * @param ysize Height of the world
 * @param num_cities Number of cities 
 * @param seed To generate a random world, -1, or specify which world is to be created
 */
...
/**
 * @brief Get a list of cities traveled to
 *
 * @return vector of cities
 * @param length the number of cities, not inluding the start
 */
